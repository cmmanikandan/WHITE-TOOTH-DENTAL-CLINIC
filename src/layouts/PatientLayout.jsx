  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-primary-50">
      <div className="animate-pulse w-32">
        <img src={navLogo} alt="White Tooth Dental Clinic" className="w-full h-auto rounded-full object-cover" />
      </div>
    </div>
  );
      ...
      <header className="bg-white border-b border-slate-100 px-6 py-4 sticky top-0 z-40">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-slate-900 font-bold hidden sm:inline">White Tooth</span>
          </div>
          <button 
